...
public class RESTClientApp {
	 ...
	 * @throws IOException
	 */
	public static void searchTechers (String uri, String queryName, 
		...
		List<Teacher> result = mapper.readValue(jsonResponse, 
	 ...
	 * process JSON object from response.
	 *
	 * @throws IOException
	 */

	public static void countTeachers (String uri, String queryName) 
			throws IOException {
		...
		System.out.println("The number of teachers in Hogwarts: " +
				numberOfTeachers);	
